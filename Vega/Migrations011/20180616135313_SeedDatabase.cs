...
namespace Vega.Migrations
{
    public partial class SeedDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //migrationBuilder.Sql("INSERT INTO Features (Name, MakeId) VALUES ('Make4-NodelA', (SELECT Id FROM Models WHERE Name = 'Make1-NodelA'))");
            //migrationBuilder.Sql("INSERT INTO Features (Name, MakeId) VALUES ('Make4-NodelB', (SELECT Id FROM Models WHERE Name = 'Make1-NodelA'))");
            //migrationBuilder.Sql("INSERT INTO Features (Name, MakeId) VALUES ('Make4-NodelC', (SELECT Id FROM Models WHERE Name = 'Make1-NodelA'))");
            //migrationBuilder.Sql("INSERT INTO Features (Name, MakeId) VALUES ('Make4-NodelD', (SELECT Id FROM Models WHERE Name = 'Make1-NodelA'))");
        }
